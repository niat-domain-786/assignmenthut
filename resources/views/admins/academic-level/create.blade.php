...
@section('content')
    ...
    <div class="row"style="padding-top:15px;">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Add Academic Level</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li><a href="#">Manage Academic Level</a></li>
                    <li class="active">Add Academic Level</li>
                </ol>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url'=>'admin/academic-level','class'=>'form-horizontal','id'=>'newUser','method'=> 'POST','files' => true)) !!}
                ...
                <div class="form-group  m-b-0">
                    <div class="col-md-12">
                        <button class="btn btn-success waves-effect waves-light" type="submit">Save Academic Level</button>
