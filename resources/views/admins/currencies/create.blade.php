...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url'=>'admin/currency','class'=>'form-horizontal','id'=>'newUser','method'=> 'POST','files' => true)) !!}
                    ...
                    {{-- <form class="form-horizontal" role="form"> --}}
                        ...
                        <div class="row">
                            <div class="col-md-12">                           
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class="control-label">Value (Base currency: USD)</label>
                ...
                <div class="form-group  m-b-0">
                    <div class="col-md-12">
                        <button class="btn btn-success waves-effect waves-light" type="submit">Save Currency</button>
