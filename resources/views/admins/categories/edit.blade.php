...
@section('content')    
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url'=>'admin/category/'.$category->id,'class'=>'form-horizontal','id'=>'newUser','method'=> 'PUT','files' => true)) !!}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="subject_id" id="" class="form-control">
                                            @foreach ($subjects as $subject)
                                                <option value="{{ $subject->id }}" @if($category->subject->id == $subject->id) selected @endif>{{ $subject->name }}</option>
                                            @endforeach    
                                        </select>                                  
                                    </div>                                    
                                </div>
                ...
                <div class="form-group m-b-0">
                    <div class="col-md-12">
                        <button class="btn btn-success waves-effect waves-light" type="submit">Update Subject</button>
...
<div class="form-group">
    <div class="col-md-12">
        <label class="control-label">Content</label>
        <textarea name="content" id="" cols="30" rows="10">{{ old('name')?? $category->name }}</textarea>
    </div>
</div> 
 --}}
