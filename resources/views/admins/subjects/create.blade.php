...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url'=>'admin/subject','class'=>'form-horizontal','id'=>'newUser','method'=> 'POST','files' => true)) !!}
                ...
                <div class="form-group  m-b-0">
                    <div class="col-md-12">
                        <button class="btn btn-success waves-effect waves-light" type="submit">Save Subject</button>
