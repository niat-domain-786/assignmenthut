...
@section('content')    
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url'=>'admin/subject/'.$subject->id,'class'=>'form-horizontal','id'=>'newUser','method'=> 'PUT','files' => true)) !!}
...
<div class="form-group">
    <div class="col-md-12">
        <label class="control-label">Content</label>
        <textarea name="content" id="" cols="30" rows="10">{{ old('name')?? $subject->name }}</textarea>
    </div>
</div> 
 --}}
