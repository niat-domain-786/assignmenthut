        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>All Revisions List</b></h4></div>
                ...
                <table  id="datatable-buttons"  class="table table-striped  table-colored table-info">
                    ...
                    <tbody>
                        ...
                        <tr   style='cursor: pointer; cursor: hand;' onclick="window.location='{{ route('admin.order.deliver_revisions',[$revision->id]) }}'">
                            ...
                            <td>{{$revision->service->name}}</td>
                            <td>{{$revision->iteration}}</td>
                            <td>{{ date('F d, Y ', strtotime($revision->updated_at))}}</td>
                         {{--    <td>
                              <a href="{{ route('admin.order.deliver_revisions',[$revision->id]) }}" class="btn btn-icon btn-xs waves-effect waves-light btn-info" target="_blank"> <i class="fa fa-eye"></i> </a>
                            </td>  --}}
                        </tr>
                        @endforeach
